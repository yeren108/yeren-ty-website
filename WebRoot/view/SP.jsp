...
<body>
	...
	<div id="body" style="width: 100%;text-align: center;background-color: #F0F0F0;">
		<table border="0" width="100%" style="text-align: center;">
			...
			<tr>
				<td style="padding: 15px;"><a href="${pageContext.request.contextPath}/view/main.jsp" ><img alt="见证" src="${logo}/sp.png"></a></td>
			</tr>
			<tr>
				<td colspan="7" style="background-color: #632443;height: 10px"></td>
			</tr>
...
<script type="text/javascript">
	...
	//初始化页面
	$(function(){
		showLink(6,20,"#line1","#line2","#line3","#line4");
	...
	function appendLink(name,url,where){
		var td=
				"<td width='20%'  style='text-align: center;'>"+
					"<div>"+
						"<a href='"+url+"' target='_blank' style='text-align: center;'><img alt='见证' src='${logo}/shipin.png'></a>"+
					"</div>"+
					"<div>"+
						name+
					"</div>"+
