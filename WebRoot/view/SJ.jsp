...
<body>
	...
	<div id="body" style="width: 100%;text-align: center;background-color: #F0F0F0;">
		<table border="0" width="100%" style="text-align: center;">
			...
			<tr>
				<td style="padding: 15px;"><a href="${pageContext.request.contextPath}/view/main.jsp" ><img alt="见证" src="${logo}/sj.png"></a></td>
			</tr>
			<tr>
				<td colspan="7" style="background-color: #632443;height: 10px"></td>
			</tr>
	...
	function appendLink(name,url,where){
		var td=
				"<td width='20%'  style='text-align: center;'>"+
					"<div>"+
						"<a href='"+url+"' target='_blank' style='text-align: center;'><img alt='见证' src='${logo}/shuji.png'></a>"+
					"</div>"+
					"<div>"+
						name+
					"</div>"+
